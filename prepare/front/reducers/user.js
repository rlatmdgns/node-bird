...
export const initialState = {
  loadUserLoading: false, // 유저 정보가져오기
  loadUserDone: false,
  loadUserError: null,
  followLoading: false,
  followDone: false,
...
const dummyUser = (data) => ({
  ...
  id: 1,
  Posts: [{ id: 1 }],
  Followings: [{ nickname: 'asd' }, { nickname: '123123' }, { nickname: 'asdasdas' }, { nickname: 'zxczc' }],
  Followers: [{ nickname: 'asd' }, { nickname: '123123' }, { nickname: 'asdasdas' }, { nickname: 'zxczc' }],
}); // 시퀄라이즈로 합쳐주기 때문에 대문자
